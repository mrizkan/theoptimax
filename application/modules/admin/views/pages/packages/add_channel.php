                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li><a href="<?= base_url('admin/packages/edit/').$objData->PackagesId ?>"> Edit Package</a></li>
                ...
                <div class="col-sm-12">
                    ...
                    <div>
                        ...
                        <?php foreach ($channelTags as $channelTag): ?>
                            ...
                            <div class="row ">
                                <select class="select2 form-control select2-multiple" multiple="multiple" multiple data-placeholder="Choose ..." name="ChannelList[<?= $channelTag->ChannelTagId ?>][]">
